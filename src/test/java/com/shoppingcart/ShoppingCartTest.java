...
public class ShoppingCartTest extends FrameworkTest {
    ...
    public void validGiftVoucherOnShoppingCart() {
        ...
        assertEquals("30.00€", cartPage.getProductPriceWithDiscount().getText(), "Verify discounted product price");
        assertTrue(cartPage.getShoppingCart().getText().contains("1 item(s) - 30.00€"), "Verify shopping cart Label");
    }
